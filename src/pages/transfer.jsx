...
function Transfer() {
  return (
    <div className="h-[100vh] flex flex-col">
      {/* Header */}
      <div className="bg-[#ffcb32] p-4 h-[141px] md:rounded-b-[3rem] rounded-b-[2.3rem] shadow-[0px_4px_20px_0px_#862CB340]">
      ...
      <div className="mt-[2rem] mx-4 md:mx-10 grow">
        <h1 className="font-bold text-xl mb-[2rem]">Latest Transfer</h1>
      ...
      <Link
        to="/TransferForm"
        className="flex justify-center items-center m-4 ml-auto text-white w-[50px] h-[50px] rounded-full bg-[#52005e] cursor-pointer shadow-[4px_4px_20px_0px_#00000040]"
      >
        <FaPlus />
      </Link>
      {/* Footer */}
