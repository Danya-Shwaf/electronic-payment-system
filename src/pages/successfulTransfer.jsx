...
export default function SuccessfulTransfer({ onClose }) {
  ...
  return (
      <div className="fixed inset-0 backdrop-blur-[2px] backdrop-grayscale flex items-center justify-center z-50 p-4">
        <div className="bg-white rounded-2xl p-6 w-full overflow-auto max-w-sm mx-4 relative max-h-screen">
          {/* Success Icon */}
          ...
          <div className="text-center">
            ...
            <div className="p-4 mb-4 flex flex-col items-center justify-between">
              ...
              <div className="flex items-center">
                <div className="w-14 h-14 bg-black rounded-full flex items-center justify-center text-white font-semibold text-sm mr-3">
                  AM
                </div>
                <div>
